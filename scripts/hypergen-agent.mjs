...
async function selfTest() {
  ...
  const requiredSnippets = [
    ...
    ["README.md", "Direct agent Postiz calls are permission-gated"],
    ["README.md", "posting.createPosts: true"],
    ["README.md", "posting.approvalMode: \"auto\""],
    ["README.md", "before caption credits"],
    ...
    ["SKILL.md", "Direct agent Postiz calls are permission-gated"],
    ["SKILL.md", "posting.approvalMode: \"auto\""],
    ["SKILL.md", "before caption credits"],
    ...
    ["hypergen.requests.json", "saved posting permission"],
    ...
    ["references/api.md", "Direct agent Postiz calls are gated by saved posting permission"],
    ["references/api.md", "does not spend caption credits"],
